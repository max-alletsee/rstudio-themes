...
# load all themes
rstudio_themes <- read.csv("inst/extdata/rstudio_themes.csv")
...
write.csv(rstudio_themes,
          file = "inst/extdata/rstudio_themes.csv",
          row.names = FALSE)
...
You can find [here](https://github.com/max-alletsee/rstudio-themes/blob/master/inst/extdata/rstudio_themes.csv) a CSV file, also including links to screenshots if available.
...
To add your own theme to the list, please open a pull request, add your theme to the file [inst/extdata/rstudio_themes.csv](https://github.com/max-alletsee/rstudio-themes/blob/master/inst/extdata/rstudio_themes.csv) and re-knit the file README.rmd. 
