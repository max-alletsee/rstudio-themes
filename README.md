...
- elmrs Dark ([repo](https://github.com/nmishra93/elmrs_dark), [direct
  link](https://raw.githubusercontent.com/nmishra93/elmrs_dark/blob/main/elmrs_dark.rstheme))
...
- rscentheme Iris Malikhân
  ...
  RStudio Scented Themes is an package with themes for R Studio inspired
  by perfumes. Iris is inspired by Iris Malikhân Maison Crivelli
...
- BreezeDefault
  ...
  a theme matching the Breeze theme in KDE Plasma
- catppuccin-latte ([repo](https://github.com/catppuccin/rstudio),
  [direct
  link](https://raw.githubusercontent.com/catppuccin/rstudio/blob/main/catppuccin-latte.rstheme),
  [screenshot](https://raw.githubusercontent.com/catppuccin/rstudio/main/assets/latte.webp)):
  a collection of soothing pastel themes for RStudio
- Driven Snow ([repo](https://github.com/mkearney/driven-snow), [direct
...
- Dutch Delight ([repo](https://github.com/jpsnijder/tmThemes), [direct
...
- Elm light {rsthemes} ([repo](https://github.com/gadenbuie/rsthemes/),
  [direct
  ...
  from the rsthemes package
- Epergoes (Light) ([repo](https://github.com/DesiQuintans/epergoes),
  [direct
  link](https://github.com/DesiQuintans/epergoes/releases/download/1.0.0/Epergoes_Light.rstheme),
  [screenshot](https://github.com/DesiQuintans/epergoes/raw/main/readme_files/preview_r.png)):
  a colourblind-safe light theme for RStudio
- Espresso ([repo](https://github.com/jealcalat/rstudio_themes), [direct
...
- Fastverse Light ([repo](https://github.com/fastverse/codethemes),
  ...
  TexMate code themes, inspired by fastverse colours, mainly intended
  for the RStudio IDE.
- Flat White {rsthemes} ([repo](https://github.com/gadenbuie/rsthemes),
  [direct
...
- GitHub {rsthemes} ([repo](https://github.com/gadenbuie/rsthemes),
  ...
  from the rsthemes package
- Mamène ([repo](https://github.com/Bhaerlin/RStheme/), [direct
  link](https://raw.githubusercontent.com/Bhaerlin/RStheme/blob/main/Mamène.rstheme))
- Material Lighter
  ([repo](https://github.com/lusignan/RStudio-Material-Theme), [direct
...
- NHL Light ([repo](https://github.com/themechanicalbear/nhlthemes),
  ...
  a collection of themes with color schemes based on the NHL themes. all
  in a light setting. currently only works on Mac
- Noodle ([repo](https://github.com/benharrap/noodle-rstheme), [direct
  link](https://raw.githubusercontent.com/benharrap/noodle-rstheme/blob/main/noodle.rstheme))
...
- One Light {rsthemes} ([repo](https://github.com/gadenbuie/rsthemes),
  ...
  from the rsthemes package
- OneHalfLight ([repo](https://github.com/LeiGuo0812/myRstudioThemes/),
  [direct
...
- Pebble-safe ([repo](https://github.com/DesiQuintans/pebble-themes),
  ...
  a light theme with colourblind-friendly colours from the RColorBrewer
  package
- Pebble-Safe Light
...
- Primolius_Color
  ([repo](https://github.com/irwingss/masterX-RStudio-Theme), [direct
  link](https://raw.githubusercontent.com/irwingss/masterX-RStudio-Theme/blob/main/Primolius_Color.rstheme)):
  los temas de RStudio creados para las clases del Instituto de Ciencias
  Antonio Brack
- rscentheme Blanche ([repo](https://github.com/florale/rscentheme),
  ...
  RStudio Scented Themes is an package with themes for R Studio inspired
  by perfumes. blanche is inspired by Blanche Byredo
- rscentheme Delina ([repo](https://github.com/florale/rscentheme),
  ...
  RStudio Scented Themes is an package with themes for R Studio inspired
  by perfumes. Delina is inspired by Delina Parfums de Marly
- rscentheme Pluriel ([repo](https://github.com/florale/rscentheme),
  ...
  RStudio Scented Themes is an package with themes for R Studio inspired
  by perfumes. Pluriel is inspired by Feminin and Masculin Pluriel
...
- Simple Nord (Sophychen)
  ([repo](https://github.com/sophychen79/themes), [direct
  link](https://raw.githubusercontent.com/sophychen79/themes/blob/main/simple-nord.rstheme),
  [screenshot](https://raw.githubusercontent.com/sophychen79/themes/main/simple-nord.png)):
  simple-nord is a custom RStudio theme that modified based on Elm light
  and Nord Snow Storm theme
...
- Textmate (high contrast comments)
  ...
  a version of the default Textmate theme with higher contrast comments
